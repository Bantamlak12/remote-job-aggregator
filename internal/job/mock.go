...
// EmploymentType, and RemoteTypeRemote/RemoteTypeHybrid (deliberately no
// onsite or unknown fixture — a remote-job aggregator's illustrative
// data leans remote/hybrid; both remaining values are still fully valid
// filter values, they simply match zero of these fixtures today, which
// is a real, legitimate outcome, not a bug), and a mix of worldwide vs.
	...
	return []Job{
		{
			...
			CompanyName: "Spotify", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "Airbnb", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "GitLab", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "Automattic", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "Zapier", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "Doist", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeContract,
		...
		},
		{
			...
			CompanyName: "Toptal", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypePartTime,
		...
		},
		{
			...
			CompanyName: "Buffer", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "Basecamp", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "DuckDuckGo", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeFullTime,
		...
		},
		{
			...
			CompanyName: "InVision", RemoteType: RemoteTypeRemote, EmploymentType: EmploymentTypeInternship,
